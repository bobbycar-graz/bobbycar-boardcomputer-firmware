...

    {
      ...
      if (const esp_app_desc_t *app_desc = esp_ota_get_app_description())
      {
...

        {
          HtmlTag trTag { "tr", body };
          {
            ...
            body += "Current project_name";
          }
          {
            HtmlTag tdTag { "td", body };
            body += esphttpdutils::htmlentities(app_desc->project_name);
          }
        }

        {
          ...
          {
            HtmlTag tdTag { "td", body };
            body += esphttpdutils::htmlentities(app_desc->version);
          }
        }

        {
          ...
          {
            HtmlTag tdTag { "td", body };
            body += "Current secure_version";
          }
          {
            HtmlTag tdTag { "td", body };
            body += std::to_string(app_desc->secure_version);
          }
        }

        {
          ...
          {
            HtmlTag tdTag { "td", body };
            body += esphttpdutils::htmlentities(fmt::format("{} {}", app_desc->date, app_desc->time));
          }
        }

        {
          ...
          {
            HtmlTag tdTag { "td", body };
            body += "Current idf_ver";
          }
          {
            HtmlTag tdTag { "td", body };
            body += esphttpdutils::htmlentities(app_desc->idf_ver);
          }
        }

        {
          ...
          {
            HtmlTag tdTag { "td", body };
            body += esphttpdutils::htmlentities(espcpputils::toHexString({ app_desc->app_elf_sha256, 8 }));
          }
        }
      }
      else
      ...
      if (asyncOta)
      {
...

        {
          ...
          {
            HtmlTag tdTag { "td", body };
            body += esphttpdutils::htmlentities(toString(asyncOta->status()));
          }
        }
...

        {
          ...
          {
            HtmlTag tdTag { "td", body };
            body += esphttpdutils::htmlentities(asyncOta->message());
          }
        }
        ...
        {
          {
            ...
            {
              HtmlTag tdTag { "td", body };
              body += "New project_name";
            }
            {
              HtmlTag tdTag { "td", body };
              body += esphttpdutils::htmlentities(appDesc->project_name);
            }
          }

          {
            ...
            {
              HtmlTag tdTag { "td", body };
              body += esphttpdutils::htmlentities(appDesc->version);
            }
          }

          {
            ...
            {
              HtmlTag tdTag { "td", body };
              body += "New secure_version";
            }
            {
              HtmlTag tdTag { "td", body };
              body += std::to_string(appDesc->secure_version);
            }
          }

          {
            ...
            {
              HtmlTag tdTag { "td", body };
              body += esphttpdutils::htmlentities(fmt::format("{} {}", appDesc->date, appDesc->time));
            }
          }

          {
            ...
            {
              HtmlTag tdTag { "td", body };
              body += esphttpdutils::htmlentities(appDesc->idf_ver);
            }
          }

          {
            ...
            {
              HtmlTag tdTag { "td", body };
              body += esphttpdutils::htmlentities(espcpputils::toHexString({ appDesc->app_elf_sha256, 8 }));
            }
          }
        }
      }
